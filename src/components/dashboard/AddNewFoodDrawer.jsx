...
const AddNewFoodDrawer = ({ isOpen, drawerOpenHandler, addNewFoodItem, setSpinner }) => {
    ...
    const onSubmit = data =>{ 
        ...
        .then(response => {
            ...
            addNewFoodItem(prevState => [...prevState,response.data])
  ...
  return (
    <div className="w-full h-full relative">
      <div
        className={`fixed overflow-y-scroll w-2/6 h-full bg-white shadow-2xl shadow-gray-400 rounded-none sm:rounded-tl-2xl overflow-hidden top-0 right-0 z-50 transition duration-1000 ease-in-out ${
